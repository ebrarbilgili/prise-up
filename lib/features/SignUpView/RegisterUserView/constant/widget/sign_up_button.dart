...
class _RegisterUserButtonState extends State<RegisterUserButton> {
  ...
  Future<void> onPressed(BuildContext context) async {
    if (widget.viewModel.passwordController.text ==
      ...
      if (regex.hasMatch(widget.viewModel.emailController.text)) {
        ...
        return buildShowDialog(context, LocaleKeys.sign_up_valid_email.locale,
            LocaleKeys.sign_up_warning.locale, null);
      }
    } else {
